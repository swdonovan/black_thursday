...
class ItemTest < Minitest::Test
  ...
  def test_it_shows_the_right_information_passed_through_at_initialize
    a = Item.new({:name => "Tyler", :id => "a million", :description => "Monster Spray",
      :unit_price => "more than you can afford", :created_at => "2016-01-11 11:51:37 UTC", :updated_at => "2016-01-11 11:51:37 UTC", :merchant_id => "Prince smbol"}, ItemRepository)
  ...
  def test_it_shows_the_right_information_passed_different_info
    a = Item.new({:name => "Bruce", :id => "685521578", :description => "Not avaliable",
      :unit_price => "40000", :created_at => "2016-01-11 11:51:37 UTC", :updated_at => "2016-01-11 11:51:37 UTC", :merchant_id => "56843166496526862"}, ItemRepository)
  ...
  def test_unit_price_to_dollars_correctly_converts_different_number_to_float
    a = Item.new({:name => "Bruce", :id => "685521578", :description => "Not avaliable",
      :unit_price => "525", :created_at => "2016-01-11 11:51:37 UTC", :updated_at => "2016-01-11 11:51:37 UTC", :merchant_id => "56843166496526862"}, ItemRepository)
    expected = 5.25
    actual = a.unit_price_to_dollars
  ...
  def test_unit_price_to_dollars_correctly_only_returns_2_decimal_points
    a = Item.new({:name => "Bruce", :id => "685521578", :description => "Not avaliable",
      :unit_price => "525.964672", :created_at => "2016-01-11 11:51:37 UTC", :updated_at => "2016-01-11 11:51:37 UTC", :merchant_id => "56843166496526862"}, ItemRepository)
    expected = 5.26
    actual = a.unit_price_to_dollars
  ...
  def test_unit_price_to_dollars_correctly_only_returns_2_decimal_points_again
    a = Item.new({:name => "Bruce", :id => "685521578", :description => "Not avaliable",
      :unit_price => "1.23124565314865", :created_at => "2016-01-11 11:51:37 UTC", :updated_at => "2016-01-11 11:51:37 UTC", :merchant_id => "56843166496526862"}, ItemRepository)
    expected = 0.01
    actual = a.unit_price_to_dollars
