...
class InvoiceItemTest < Minitest::Test
  ...
  def setup
    ...
    @ii_3 = InvoiceItem.new({
      ...
      :invoice_id => 48,
      :quantity => 15,
      :unit_price => BigDecimal.new(13.00, 3),
      :created_at => Time.now,
      :updated_at => Time.now
    }, self)
  end
  ...
  def test_ii_1
    ...
    assert_equal 10.99, @ii_1.unit_price.to_f
    assert_equal BigDecimal, @ii_1.unit_price.class
    assert_equal 10.99, @ii_1.unit_price_to_dollars
  ...
  def test_ii_2
    ...
    assert_equal 14.99, @ii_2.unit_price.to_f
    assert_equal BigDecimal, @ii_2.unit_price.class
    assert_equal 14.99, @ii_2.unit_price_to_dollars
  ...
  def test_ii_3
    ...
    assert_equal 13.0, @ii_3.unit_price.to_f
    assert_equal BigDecimal, @ii_3.unit_price.class
    assert_equal 13.0, @ii_3.unit_price_to_dollars
